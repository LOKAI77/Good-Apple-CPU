...
draw clear
movhw rA, 0
; this starts drawing color value equal to the pixel position.
; this results in a gradient from black (top left) to blue (bottom left) and cyan (blue and green max, bottom right) with green (top right).
loop:
    draw rA, rA
    inc rA, rA
    jmpi loop
